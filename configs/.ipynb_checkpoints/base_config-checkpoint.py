...
class Config:
    def __init__(self):
        ...
        ########################################################################
        # Add parameters for learnable masks
        parser.add_argument(
            "--lr_sparse",
            default=0.1,
            type=float,
            help="Learning rate for mask parameters",
        )
        parser.add_argument(
            "--lamda_sparse",
            default=0.5,
        ...
        parser.add_argument(
            ...
            default=1e-3,
            type=float,
            help="Negative sparsity penalty ratio",
        )
        parser.add_argument(
            "--snip_interval",
            default=3,
            type=int,
            help="Number of generations between SNIP reinitializations",
        )
        parser.add_argument(
            "--lambda_binary",
            default=0.01, 
            type=float,
            help="Binary penalty coefficient for learnable masks",
        )
        ########################################################################
        # General Config
        parser.add_argument(
